...
const EN = {
  ...
  'Запускать при входе в macOS': 'Start at macOS login',
  'Разделить на подколонки — по сайтам и приложениям': 'Split into sub-columns — by site and app',
  'Собрать подколонки в одну колонку': 'Merge the sub-columns back into one column',
  'Прочитать всё в подколонке, кроме закреплённого': 'Read everything in the sub-column except pinned',
